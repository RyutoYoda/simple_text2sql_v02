# Vizzy - AI-Powered Text2SQL & Data Analysis Tool
...
自然言語でデータベースに問い合わせ、自動でビジュアライゼーションを生成するAIアシスタントツールです。

## 主な機能

- **Text2SQL**: 自然言語をSQLクエリに自動変換
- **自動ビジュアライゼーション**: クエリ結果から最適なグラフを自動生成
- **マルチデータソース対応**: 5つの主要データソースに対応
- **テキストクラスタリング**: アンケートや自由記述の自動分類・要約
